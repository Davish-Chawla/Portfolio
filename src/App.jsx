...
export default function App() {
  return (
    <div className="bg-[var(--background)] text-[var(--text)]" style={{ minHeight: '100vh', padding: 0 }}>
      <Router>
        <nav className="relative bg-[var(--secondary)] text-[var(--accent)] shadow-lg">
          <ul className="flex flex-wrap items-center justify-between px-4 md:px-8 py-4">
            ...
            <a href="/image/Davish-Chawla-CV.pdf"  download>
              <button className="px-6 py-2 text-white cursor-pointer bg-gradient-to-r from-red-500 to-blue-600 rounded-lg shadow-md hover:from-blue-600 hover:to-red-500 hover:shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-pink-300">
                Download CV
              </button>
              </a>
            </div>
